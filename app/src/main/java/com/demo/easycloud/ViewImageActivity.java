...
public class ViewImageActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_download) {
            ...
            Intent redirectIntent = new Intent(ViewImageActivity.this, ShareToContactsActivity.class);
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(ViewImageActivity.this)
                .setMessage(message)
    ...
    void saveToFile() {
        ...
        if(checkPermission()) {
            ...
            StorageChooser chooser = new StorageChooser.Builder()
                    .withActivity(ViewImageActivity.this)
...
// get path that the user has chosen
            chooser.setOnSelectListener(new StorageChooser.OnSelectListener() {
                ...
                public void onSelect(String path) {
                    ...
                    new DownloadTask(ViewImageActivity.this, imageUrl, dataBundle.getString("imageTitle")+"."+dataBundle.getString("extension"), path);
                }
            });
        } else {
            requestPermission();
